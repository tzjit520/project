	...
	<div class="content-wrapper">
		<div class="outlet">
			<div class="col-xs-12 heading">
				<h1 class="page-header">产品分组列表</h1><hr/>
			</div>
			<div class="panel-body">
              	<form:form modelAttribute="group" class="form-horizontal group-border hover-stripped" method="get" role="form" id="seachForm" cssStyle="margin-bottom:20px;">
              		...
              		<div class="form-group">
          				...
          				<div class="col-xs-5">
          					...
          					<shiro:hasAnyPermissions name="group:add,group:update">
	                  			<input type="button" id="btnAdd" class="btn btn-success" onclick="window.location.href='${ctx}/api/v1/group/0'" value="添加">
                 	...
                 	<thead>
                  	...
                  	<tbody>
                      	<c:forEach items="${page.data}" var="group">
							<tr>
								<td style="width:5px;">
	                           		<input type="checkbox" value="${group.id}" name="child_items">
	                           	</td>
								<td>${group.name}</td>
								<td>${group.remark}</td>
							</tr>
    ...
    <script type="text/javascript">
	    ...
	    $('#btnUpdate').click(function() {
			...
			if(node_count <= 0){
				...
				window.location.href = "${ctx}/api/v1/group/"+id;
			}
		});
		...
		function page(num, pageSize){
			...
			$("#seachForm").attr("action","${ctx}/api/v1/group");
			$("#seachForm").submit();
		}
