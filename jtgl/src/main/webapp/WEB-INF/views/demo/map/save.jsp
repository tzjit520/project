            		...
            		<div class="row" >
                        ...
                        <div class="form-group">
	                        <form id="uploadImgForm" action="${ctx}/api/v1/user/upload" method="POST" enctype="multipart/form-data">
	                            <label for="name" class="col-xs-1 control-label">照片:</label>
	                            <div class="col-xs-5 ">
                        ...
                        <div class="form-group">
	                        <form id="uploadAttachmentForm" action="${ctx}/api/v1/user/upload" method="POST" enctype="multipart/form-data">
	                            <label for="name" class="col-xs-1 control-label">上传附件:</label>
	                            <div class="col-xs-5">
                        ...
                        <div class="form-group">
                            <div class="col-xs-offset-1">
                                <input type="submit" id="saveBtn" value="保存" class="btn btn-primary ml15"/>
                                <input type="button" id="backBtn" value="返回" onclick="history.go(-1)" class="btn btn-info ml15"/>
                            </div>
                        </div>
            		</div>
           		</form:form>
