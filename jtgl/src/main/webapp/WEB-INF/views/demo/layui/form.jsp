	...
	<div class="layui-fluid">
		...
		<form class="layui-form layui-form-pane1" action="" lay-filter="first">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="phone" lay-verify="required|number" lay-verType="tips" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">邮箱</label>
				<div class="layui-input-inline">
					<input type="text" name="email" lay-verify="email" lay-verType="alert" autocomplete="off" class="layui-input">
				</div>
			...
			<div class="layui-form-item layui-form-text">
				...
				<div class="layui-input-inline">
					<textarea placeholder="请输入内容" class="layui-textarea" cols="50" name="desc"></textarea>
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-input-block">
