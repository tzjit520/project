...
<body>
	<div class="content-wrapper">
		<div class="col-xs-12 heading">
			<h1 class="page-header">角色管理</h1><hr/>
		</div>
		<div class="outlet">
			<div class="panel-body">
				<form:form modelAttribute="role" class="form-horizontal group-border hover-stripped" method="get" role="form" id="seachForm" cssStyle="padding-bottom:20px;">
					...
					<div class="form-group">
						...
						<div class="col-xs-5">
							...
							<shiro:hasPermission name="role:add">
								<input type="button" id="btnAdd" class="btn btn-success" onclick="window.location.href='${ctx}/api/v1/role/0'" value="添加">
							</shiro:hasPermission>
				...
				<table class="table table-bordered">
					...
					<tbody>
						<c:forEach items="${page.data}" var="role">
							<tr>
								<td><input type="checkbox" value="${role.id}" name="child_items"></td>
								<td>${role.code}</td>
								<td>${role.name}</td>
								<td>${role.remark}</td>
							</tr>
	...
	<script type="text/javascript">
	    ...
	    $('#btnUpdate').click(function() {
			...
			if(node_count <= 0){
				...
				window.location.href = "${ctx}/api/v1/role/"+id;
			}
		});
