	...
	<div class="content-wrapper">
		<div class="outlet">
			<div class="col-xs-12 heading">
				<h1 class="page-header">资源管理</h1><hr/>
			</div>
			<div class="panel-body">
				<form:form modelAttribute="resource" class="form-horizontal group-border hover-stripped" method="get" role="form" id="seachForm" cssStyle="padding-bottom:20px;">
					...
					<div class="form-group">
						...
						<div class="col-xs-5">
							...
							<shiro:hasPermission name="resource:add">
								<input type="button" id="btnAdd" class="btn btn-success" onclick="window.location.href='${ctx}/api/v1/resource/0'" value="添加">
							</shiro:hasPermission>
				...
				<table class="table table-bordered">
					...
					<tbody>
						<c:forEach items="${page.data}" var="resource">
							<tr>
								<td><input type="checkbox" value="${resource.id}" name="child_items"></td>
								<td>${resource.code}</td>
								<td>${resource.name}</td>
	...
	<script type="text/javascript">
	    ...
	    $('#btnUpdate').click(function() {
			...
			if(node_count <= 0){
				...
				window.location.href = "${ctx}/api/v1/resource/"+id;
			}
		});
		...
		function page(num, pageSize){
			...
			$("#seachForm").attr("action","${ctx}/api/v1/resource");
			$("#seachForm").submit();
		}
    </script>
