	...
	<div class="content-wrapper">
		<div class="outlet">
			<div class="col-xs-12 heading">
				<h1 class="page-header">功能管理</h1><hr/>
			</div>
			<div class="panel-body">
				<form:form modelAttribute="permission" class="form-horizontal group-border hover-stripped" method="get" role="form" id="seachForm" cssStyle="padding-bottom:20px;">
					<form:hidden path="pageIndex" id="pageIndex" />
					<form:hidden path="pageSize" id="pageSize" />
					<div class="form-group">
						<label for="resourceName" class="col-xs-1 control-label">资源名：</label>
						<div class="col-xs-2">
							<form:input path="resourceName" id="resourceName" cssClass="form-control" />
						</div>
						<label for="operationName" class="col-xs-1 control-label">操作名：</label>
						<div class="col-xs-2">
						...
						<div class="col-xs-4">
							...
							<shiro:hasPermission name="permission:add">
								<input type="button" id="btnAdd" class="btn btn-success" onclick="window.location.href='${ctx}/api/v1/permission/0'" value="添加">
							</shiro:hasPermission>
				...
				<table class="table table-bordered">
					...
					<tbody>
						<c:forEach items="${page.data}" var="permission">
							<tr>
								<td>
									<input type="checkbox" value="${permission.id}" name="child_items">
								</td>
	...
	<script type="text/javascript">
	    ...
	    $('#btnUpdate').click(function() {
			...
			if(node_count <= 0){
				...
				window.location.href = "${ctx}/api/v1/permission/"+id;
			}
		});
		...
		function page(num, pageSize){
			...
			$("#seachForm").attr("action","${ctx}/api/v1/permission");
			$("#seachForm").submit();
		}
    </script>
</body>
