	...
	<div class="content-wrapper">
		<div class="outlet">
			<div class="col-xs-12 heading">
				<h1 class="page-header">${empty lovLine.id?'添加':'修改'}字典数据</h1><hr/>
			</div>
			<div class="panel-body">
				<form:form modelAttribute="lovLine" action="${ctx}/api/v1/lovLine" lovLine="form" id="lovLineForm" onsubmit="return submitForm()" class="form-horizontal group-border hover-stripped">
					<form:hidden path="id" id="id" />
					<input type="hidden" name="_method" value="${empty lovLine.id?'POST':'PUT'}">

					<div class="form-group">
						<label for="name" class="col-xs-1 control-label">字典类型：</label>
						<div class="col-xs-2">
							<form:select path="lovId" cssClass="form-control required">
					...
					<div class="form-group">
						<label for="name" class="col-xs-1 control-label">数据名称：</label>
						<div class="col-xs-2">
							<form:input path="name" id="name" cssClass="form-control required" />
						</div>
					</div>
					<div class="form-group">
						<label for="code" class="col-xs-1 control-label">数据值：</label>
						<div class="col-xs-2">
					...
					<div class="form-group">
						...
						<div class="col-xs-11">
							...
							<button class="btn btn-info" type="button" onclick="window.location.href='${ctx}/api/v1/lovLine'">返回</button>
						</div>
					</div>
				</form:form>
			</div>
