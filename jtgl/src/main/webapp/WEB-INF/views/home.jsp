				...
				<div class="panel panel-brown panelMove">
					...
					<div class="panel-heading">
						...
						<div class="pull-right mt10">
							<a href="#" class="color-grayspr">@Private7685</a>
						</div>
					</div>
							...
							<div class="instagram-widget-image">
								<div id="instagram-widget" class="carousel slide">
									...
									<ol class="carousel-indicators dotstyle">
										<li data-target="#instagram-widget" data-slide-to="0" class="active">
											<a href="#">Image 1</a>
										</li>
										<li data-target="#instagram-widget" data-slide-to="1">
											<a href="#">Image 2</a>
										</li>
										<li data-target="#instagram-widget" data-slide-to="2">
											<a href="#">Image 3</a>
										</li>
									</ol>
									<div class="carousel-inner">
										<figure class="item active"> <img class="img-responsive" src="${ctx}/static/assets/img/private/1.png" alt="image"> </figure>
										<figure class="item"> <img class="img-responsive" src="${ctx}/static/assets/img/private/2.png" alt="image"> </figure>
										<figure class="item"> <img class="img-responsive" src="${ctx}/static/assets/img/private/3.png" alt="image"> </figure>
									</div>
								</div>
								<!-- End Carousel -->
							</div>
					...
					<div class="panel-body">
						<div class="todo-widget">
							<div class="todo-header">
								...
								<div class="todo-add">
									<a href="#" class="btn btn-primary tip" title="Add new todo">
										<i class="im-plus"></i>
									</a>
								</div>
							</div>
