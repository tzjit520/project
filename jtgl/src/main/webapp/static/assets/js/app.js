...
$(document).ready(function() {
    ...
    //统一复选框全选
	$(".table").checkAll({
		masterCheckbox: "#parentCheckbox",
		otherCheckboxes: "[name=child_items]"
	})
	
    var chboxes = $('.table').find('[name=child_items]');
	...
	$("[name=child_items]").click(function(){
    	$("#parentCheckbox").prop("checked",$("[name=clild_items]").length == $("[name=clild_items]:checked").length);
    }) */
    ...
    hljs.initHighlightingOnLoad();
 	...
 	$('body').sprFlat({
        ...
        /*backToTop: {
            ...
            imgsrc: '/jtgl/static/assets/img/backtop.png', //image 
