	...
	function _1(_2) {
		...
		_5.datagrid($.extend({}, _4, {
			...
			onLoadSuccess : function(_b) {
				...
				var _2d =_5.datagrid("getRows");
				var _2b =_5.datagrid("options");
				if(_2d.length==1){
					$(_2).combogrid("setValue", _2d[0][_2b.idField]);
					$(_2).combo("setValue", _2d[0][_2b.idField]);
					$(_2).combogrid("hidePanel");
				}
			},
			onClickRow : _e,
